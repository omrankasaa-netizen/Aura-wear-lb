// Optimize + store images (AURA).
//
// Every uploaded image (single /api/upload AND each photo in a bulk import)
...
// Which derivative the canonical url should point at. Card is the most-requested
// size, so default the stored URL to it; large/thumb live in the variants map.
...
// (/cdn-cgi/image/<opts>/<path> on images.aura-lb.shop). A resized variant
