// Pluggable object storage for product/CMS images (AURA).
//
// Two backends sit behind one interface:
//   - LOCAL disk  (default/fallback): writes under <repo>/uploads and serves
//                 via Express static at /uploads. This is what runs in local dev
//                 with no R2 configured.
//   - R2          (Cloudflare R2, S3-compatible): writes objects into AURA's own
//                 R2 bucket and builds public URLs from R2_PUBLIC_BASE_URL.
//                 Durable across redeploys (fixes the Railway ephemeral-disk
//                 problem) and fast (served from AURA's image domain/CDN).
//
