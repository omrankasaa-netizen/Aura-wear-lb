          ...
          {imgUrl && (
            ...
            >
              <div className="rounded-3xl overflow-hidden shadow-xl aspect-square">
                <img src={cmsImageSrc(imgUrl, 'card')} alt={title} width={800} height={800} loading="lazy" decoding="async" onError={handleImageError} className="w-full h-full object-cover" />
              </div>
            </motion.div>
          )}
